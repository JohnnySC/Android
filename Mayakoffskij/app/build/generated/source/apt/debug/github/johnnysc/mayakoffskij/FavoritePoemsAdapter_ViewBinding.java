...
public class FavoritePoemsAdapter_ViewBinding<T extends FavoritePoemsAdapter> implements Unbinder {
  protected T target;

  public FavoritePoemsAdapter_ViewBinding(T target, Finder finder, Object source) {
    this.target = target;
